...
class PhoneCountryModel {
  ...
  PhoneCountryModel(this.key, this.value);
}

class _SelectCountryWidgetState extends State<SelectCountryWidget> {
  List<PhoneCountryModel> countries = [];
  String selected = "";
  ...
  void initState() {
    phones.forEach((key, value) {
      countries.add(
        PhoneCountryModel(
          key,
          value.replaceFirst("(+$key)", ""),
        ),
      );
    });
    selected = context.read<ServerBloc>().state.payload["country"] ?? "";
    super.initState();
  }
      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            ...
            for (PhoneCountryModel phone in countries)
              GestureDetector(
                onTap: () {
                        ...
                        children: [
                          Expanded(
                              ...
                              child: Text(
                                ...
                                style: TextStyle(
                                  fontSize: 20,
                                    fontWeight: selected == phone.value
                                        ? FontWeight.bold
                                        : FontWeight.normal),
                              )),
                          Expanded(
